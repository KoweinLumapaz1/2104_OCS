...
public class AddPres extends javax.swing.JFrame {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            ...
            String sex = Fradio.isSelected() ? "F" : "M"; // Selects "F" if Fradio is selected, otherwise "M".
            String contact = Textcontact.getText();


            pst = con.prepareStatement("INSERT INTO prescriptions(PatientName, PatientAge, PatientAddress, PatientSex, PatientContact, PatientName, DateAppointed,ReservedDate, Diagnosis, EyeGradeLevel, GlassFrame)VALUES(?,?,?,?,?,?,?,?,?,?)");
            String PatientName = null;
            String PatientAge = null;
            String PatientAddress = null;
            String PatientSex = null;
            String PatientContact = null;
            String DateAppointed = null;
            String ReservedDate = null;
            String Diagnosis = null;
            String EyeGradeLevel = null;
            String GlassFrame = null;
            ...
            pst.setString(4,PatientSex);
            pst.setString(5,PatientContact);
